...
module.exports = function(id) {
	var extended = {
		...
		template: _.template('<div class="info-table"> <table style="width: 100%; table-layout: fixed;" class="table table-striped"> ' +
            ...
            '<tr> <td  style="width: 120px;">value</td> <td class="value" contentEditable="false" style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><%=res.wvalue %> </td> </tr>' +
            '<tr> <td  style="width: 120px;">payload</td> <td class="value" contentEditable="false" style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><%=res.wpayload %> </td> </tr>' +
			'</tbody> </table> <div>'),
